...
// A test script that sends commands to the server
const { spawn } = require('child_process');
const path = require('path');
const net = require('net');
const fs = require('fs');

console.log('Starting command test...');
  ...
  client.connect(port, '127.0.0.1', () => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        // After another 1 second, send a command to create a note
        setTimeout(() => {
          const executeCommandRequest = {
            ...
            params: {
              ...
              arguments: [`file://${testFilePath}`, 1]
            }
          };
          
          client.write(
            `Content-Length: ${Buffer.byteLength(JSON.stringify(executeCommandRequest), 'utf8')}\r\n\r\n${JSON.stringify(executeCommandRequest)}`
          );
          
          console.log('Sent executeCommand request for annotation.createNote');
